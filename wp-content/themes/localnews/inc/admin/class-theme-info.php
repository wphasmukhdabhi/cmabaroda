        ...
        ?>
            <div id="theme-info-admin">
                <div class="info-container">
                    ...
                    <div class="info-block">
                        <a href="<?php echo esc_url( '//preview.blazethemes.com/local-news/' ); ?>" target="_blank" class="dashicons dashicons-desktop info-icon"></a>
                        <p class="info-text">
                            <a href="<?php echo esc_url( '//preview.blazethemes.com/local-news/' ); ?>" target="_blank"><?php esc_html_e('Theme demo','localnews'); ?></a>
                        </p>
                    </div>
                    <div class="info-block">
